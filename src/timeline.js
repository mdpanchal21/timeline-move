...
const Timeline = ({ videoDate }) => {
  ...
  useEffect(() => {
    if (Hls.isSupported()) {
      const hls = new Hls();
      hls.loadSource(`https://media1.ambicam.com:443/dvr30/6eb06634-127d-445e-8178-8d3c1489892c/${videoDate}/6eb06634-127d-445e-8178-8d3c1489892c.m3u8`);
      ...
      videoRef.current.src = `https://media1.ambicam.com:443/dvr30/6eb06634-127d-445e-8178-8d3c1489892c/${videoDate}/6eb06634-127d-445e-8178-8d3c1489892c.m3u8`;
  ...
  useEffect(() => {
    ...
    function zoomed(event) {
      ...
      if (zoomLevel >= 1) {
        if (zoomLevel >= 8) {
          xAxis.tickValues(d3.range(0, 24.1, 0.1));
          xAxis.tickFormat(d => {
